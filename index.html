...
<body>
    ...
    <script type="module">
        ...
        async function loadUserData() {
            ...
            try {
                ...
                if (docSnap.exists()) { 
                    ...
                    gameState.coins = data.coins !== undefined ? data.coins : (gameState.displayName ? 0 : 500);
                    gameState.currentStage = data.currentStage || 1;
                    gameState.nameChangeCount = data.nameChangeCount || 0; 
        ...
        async function handleChangeDisplayName() {
            ...
            const changeNameCost = gameState.nameChangeCount === 0 ? 0 : 900; 
            ...
            if (changeNameCost > 0) { 
                const coinDeducted = await updateCoins(-changeNameCost, true); 
                if (!coinDeducted) {
        ...
        function setupEventListeners() {
            ...
            if (registerBtn) {
                registerBtn.addEventListener('click', async () => {
                    ...
                    if(isAuthReady && currentUserId && db){ 
                        ...
                        } catch(e) { console.error("Error checking existing profile:", e); }
                    }
            ...
            if (editNameBtn) {
                editNameBtn.addEventListener('click', () => {
                    ...
                    let confirmButtonText = `تغییر نام (${gameState.nameChangeCount === 0 ? "رایگان" : "900 سکه"})`;
